...
export default function AdminDashboard() {
  ...
  const { doctors, specialties } = useDirectory()
  const [patientCount, setPatientCount] = useState(0)

  useEffect(() => {
    api.get('/patients').then(({ data }) => setPatientCount(data.length))
  }, [])
  ...
  const stats = [
    ...
    { label: 'Patients', value: patientCount, icon: Users, to: '/admin/patients' },
