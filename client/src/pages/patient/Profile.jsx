...
export default function PatientProfile() {
  const { session, profile: patient, refreshProfile } = useAuth()
  ...
  async function onSubmit(data) {
    await api.patch(`/patients/${session.profileId}`, {
      name: data.name,
      phone: data.phone,
      dob: data.dob,
      gender: data.gender,
      ...
      <div className="row g-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="row">
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input className="form-control" value={patient.email} disabled />
                </div>
                <div className="col-md-6 mb-3">
        ...
        <div className="col-lg-4">
          <Card className="text-center mb-3">
            ...
            <div className="text-shq-secondary small">Patient</div>
          </Card>
